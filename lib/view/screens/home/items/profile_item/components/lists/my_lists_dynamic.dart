...
class MyListsDynamicData extends StatefulWidget {
  const MyListsDynamicData({Key? key}) : super(key: key);

  @override
  _MyCardsState createState() => _MyCardsState();
}

class _MyCardsState extends State<MyListsDynamicData> with TickerProviderStateMixin {
  List<Color> colors = [
    Color(0xff3dc295),
  ];
  int color = 0;
